locals {
  configure_aksuat_resources = {
    settings = {
      name                                             = "aks-ott007-np-ci1-argouat-0001"
      ...
      default_node_pool = {
        ...
        max_pods       = 50
        vnet_subnet_id = "/subscriptions/subs-xxxxx-xxxx/resourceGroups/rg-ott007-np-ci1-hubconnectivity-0001/providers/Microsoft.Network/virtualNetworks/vnet-ott007-np-ci1-hub-0001/subnets/snet-ott007-np-ci1-devops-0002"
      }
      ...
      private_endpoint = {
        endpoint_name   = "pep-ott007-np-ci1-argoaks-0002"
