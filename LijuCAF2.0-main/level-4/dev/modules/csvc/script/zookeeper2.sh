#! /bin/bash
log_disk=vm-ott007-dev-ci1-cssssolr-0005-datadisk-0001
log_disk_mount_path=/opt/zookeeper/logs
log_disk_owner=zookeeper
data_disk=vm-ott007-dev-ci1-cssssolr-0005-datadisk-0002
...
# gsutil cp gs://gcs-ott007-dev-solr-artifacts/solr-as1-playback/zoo.cfg /opt/zookeeper/conf/zoo.cfg
