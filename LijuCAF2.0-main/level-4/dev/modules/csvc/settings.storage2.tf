locals {
  configure_storage2_resources = {
    settings = {
      location            = "centralindia"
      resource_group_name = "rg-ott007-dev-ci1-csss-0001"
      storageaccount_name = "stott007devci1csss0002"
      network_rules = {
      ...
      private_endpoint = {
        endpoint_name        = "pep-ott007-dev-ci1-csssst-0002"
        ...
        connection_name      = "stott007devci1csss0002-pvt-connection"
